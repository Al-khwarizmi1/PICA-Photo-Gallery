...
{
var pica_token = document.getElementById('app_wp_token').value;    
 if (window.XMLHttpRequest)
{// code for IE7+, Firefox, Chrome, Opera, Safari
   xmlhttp=new XMLHttpRequest();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macAlbumname_id='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macAlbum_id='+macAlbum_id+'&macAlbum_name='+macAlbum_name+'&macAlbum_desc='+macAlbum_desc+'&pica_token='+pica_token,true);
xmlhttp.send();
}
//updating gallery
//showing the name edit form
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macGallery_id='+macGallery_id+'&pica_token='+pica_token,true);
xmlhttp.send();
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macGallery_id='+macGallery_id+'&macGallery_name='+macGal_name+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macAlbumpage_id='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macAlbum_pageid='+macAlbum_pageid+'&macAlbum_id='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?status='+status+'&albid='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
 }
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macAlbum_desc='+macAlbum_desc+'&macAlbum_id='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macgalajax.php?status='+status+'&galid='+macGallery_id+'&pica_token='+pica_token,true);
xmlhttp.send();
 }
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php?macdelAlbum='+macAlbum_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macDelid='+macPhoto_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php?macEdit='+rst+'&pica_token='+pica_token,true);
xmlhttp.send();
 }
...
function upd_disphoto(queue,albid)
{
	...
	dragdr.ajax({
    method:"GET",
       url: site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php',
       data : "macedit_phtid="+macedit_phtid+"&macedit_name="+macedit_name+"&macedit_desc="+macedit_desc+"&pica_token="+pica_token,
       asynchronous:false,
       error: function(html){
    	   //alert(xmlhttp.responseText);
            },
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php?macdeleteId='+macdeleteId+'&pica_token='+pica_token,true);
xmlhttp.send();
 }
 }
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php?macphotoDesc_id='+macPhoto_id+'&pica_token='+pica_token,true);
xmlhttp.send();
 }
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?macPhoto_name='+macPhoto_name+'&macPhotos_id='+macPhotos_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macphtajax.php?macPhoto_desc='+macPhoto_desc+'&macPhoto_id='+macPhoto_id+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
var pica_token = document.getElementById('app_wp_token').value;		
 ...
 // alert('addcover = '+addCover+'  album id = '+ albumId+' mac photo id=  '+macPhoto_id+ '  flag = '+  flag );
			 if( flag ) 
				{  
				 xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?featuredCover='+addCover+'&albumId='+albumId+'&macCovered_id='+macPhoto_id+'&isFlag='+addCover+'&pica_token='+pica_token,true);
				} 
			 else
			 { 
				 xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?albumCover='+addCover+'&albumId='+albumId+'&macCovered_id='+macPhoto_id+'&pica_token='+pica_token,true);
			  }
...
var pica_token = document.getElementById('app_wp_token').value;
 ...
 // alert('addcover = '+addCover+'  album id = '+ albumId+' mac photo id=  '+macPhoto_id+ '  flag = '+  flag );
				 ...
				 xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?albumCover='+addCover+'&albumId='+albumId+'&macCovered_id='+macPhoto_id+'&changeAlbCover='+1+'&pica_token='+pica_token,true);
...
xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/macalbajax.php?status='+status+'&macPhoto_id='+macPhoto_id+'&albIdIs='+albId+'&sortingValue='+sortingvalue+'&pica_token='+pica_token,true);
xmlhttp.send();
}
...
function showphotosreziemes()
{
  ...
  // resize photos
function photos_regenerate(flagname , resizetype , width , height ,  pageURL, upload_token)
{
	...
	xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/picaPhotosResize.php?photoThumbGenerate='+flagname+'&photoResize='+resizetype+'&width='+width+'&height='+height+'&upload_token='+upload_token,true);
	xmlhttp.send();
...
function changesortingorderinalbum(order , site_url , mac_folder  )
{
	...
	xmlhttp.open("GET",site_url+'/wp-content/plugins/'+mac_folder+'/process-sortable.php?'+order+'&pica_token='+pica_token,true);
	xmlhttp.send();
 }
...
a condition and only a single check box came in a list.
    ...
    return;
				...
				function deleteImages(){
					var comlist  = document.forms['macPhotos'].elements['checkList[]'];
					var j = 0;
					var is_checked = false;
					for (j = 0; j<comlist.length; j++) {						
                        if(comlist[j].checked == true){
                        	  is_checked = true;
                              break;
                    }
					}
